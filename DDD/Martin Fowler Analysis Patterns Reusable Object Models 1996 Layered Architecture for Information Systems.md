...
OO databases have responded to this by providing <font color="#00ffcc">gateways to tradi-tional database products</font>.\
In this approach an <font color="#00ffcc">OO database can act as the transaction control mechanism without necessarily storing any data itself.</font>
